...
function header_left() {
    return html`
        <div class="header__left">
            ...
            <div class="header__left-mini-bar">
                <i class="fas fa-bars"></i>
            </div>

            <div class="header__left-logo">
                <a class="autodesk-logo" href="https://www.autodesk.com" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1619.27 166.13">
                        <path class="autodesk-logo-new" fill="#fff" 
            ...
            <div class="header__left-search">
                <div class="left-search__wrap">
                    <svg class="header__search-icon left" xmlns="http://www.w3.org/2000/svg" fill="none">
                    ...
                    <input class="left-search__input" type="text">
                    <div class="left-search__history">
                        <h3 class="left-search__history-heading">Recent searches will appear here</h3>
                    </div>
                </div>
            </div>
        </div>
